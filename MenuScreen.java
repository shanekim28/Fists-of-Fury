		...
		nifty2.addScreen("start", new ScreenBuilder("start") {
			{
						...
						panel(new PanelBuilder("Bottom_Up3") {
							{
								...
								// Join button starts game when clicked
						...
						panel(new PanelBuilder("Bottom_Up2") {
							{
								...
								// Host Button calls StartServer() when clicked
                ...
                // Game/ hub screen
                // Color transparent in order to show game
                // Sadly not enough time to implement score cards
